...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'PiyasGenDrive',
    "address" TEXT NOT NULL DEFAULT 'Sathmatha , Bogura Sadar, Bogura',
    "phone" TEXT NOT NULL DEFAULT '01743109234',
    "email" TEXT NOT NULL DEFAULT 'contact@piyasgendrive.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
